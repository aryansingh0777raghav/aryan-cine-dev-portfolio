          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <a href="https://github.com/aryansingh0777raghav" target="_blank" rel="noreferrer" className="w-16 h-16 md:w-20 md:h-20 glass rounded-3xl flex items-center justify-center text-white/40 hover:text-white hover:scale-110 hover:border-white/20 transition-all group">
                  <Github size={24} className="group-hover:rotate-12 transition-transform" />
                </a>
                <a href="https://www.linkedin.com/in/iamaryan07" target="_blank" rel="noreferrer" className="w-16 h-16 md:w-20 md:h-20 glass rounded-3xl flex items-center justify-center text-white/40 hover:text-white hover:scale-110 hover:border-white/20 transition-all group">
                  <Linkedin size={24} className="group-hover:-rotate-12 transition-transform" />
                </a>
                <a href="https://www.instagram.com/iam_aryannnn07" target="_blank" rel="noreferrer" className="w-16 h-16 md:w-20 md:h-20 glass rounded-3xl flex items-center justify-center text-white/40 hover:text-white hover:scale-110 hover:border-white/20 transition-all group">
                  <svg className="w-6 h-6 group-hover:scale-110 transition-transform fill-current" viewBox="0 0 24 24">
