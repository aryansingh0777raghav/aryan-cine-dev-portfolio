  ...
  return (
    <section id="home" className="pt-36 md:pt-44 pb-20 md:pb-28 bg-white relative border-b border-neutral-200">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Full-Width Panoramic Cinematic Frame (120 FPS Hardware Optimized) */}
        <div className="mt-12 sm:mt-16 p-1.5 sm:p-2 rounded-2xl sm:rounded-3xl bg-[#0A0A0A] border border-neutral-800 shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
          <div className="w-full rounded-xl sm:rounded-2xl overflow-hidden border border-neutral-800/80 bg-black">
            <img 
