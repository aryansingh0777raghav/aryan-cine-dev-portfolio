            ...
            <div className="glass rounded-3xl md:rounded-[3rem] p-8 md:p-12 border border-white/5 h-full flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <div className="space-y-8 w-full">
                <div className="flex flex-col lg:flex-row items-center lg:items-center gap-4 lg:gap-6 group">
                  <div className="w-14 h-14 rounded-2xl glass flex items-center justify-center text-white/50 group-hover:bg-white group-hover:text-black transition-colors duration-300">
                    <Mail size={22} />
                  </div>
                  <div>
              ...
              <div className="mt-16 pt-10 border-t border-white/5 flex justify-center lg:justify-start gap-4 w-full">
                <a href="https://github.com/aryansingh0777raghav" target="_blank" rel="noreferrer" className="w-14 h-14 glass rounded-2xl flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-colors duration-300">
                  <Github size={22} />
                </a>
                <a href="https://www.linkedin.com/in/iamaryan07" target="_blank" rel="noreferrer" className="w-14 h-14 glass rounded-2xl flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-colors duration-300">
                  <Linkedin size={22} />
                </a>
                <a href="https://www.instagram.com/iam_aryannnn07" target="_blank" rel="noreferrer" className="w-14 h-14 glass rounded-2xl flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-colors duration-300">
              ...
              >
                <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      required
                      className="w-full px-8 py-5 glass-dark border border-white/5 rounded-2xl focus:outline-none focus:border-white/20 transition-colors duration-300 text-sm font-medium placeholder:text-white/20"
                    />
                  </div>
                  <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  <textarea 
                    ...
                    required
                    className="w-full px-8 py-5 glass-dark border border-white/5 rounded-[2rem] focus:outline-none focus:border-white/20 transition-colors duration-300 text-sm font-medium placeholder:text-white/20 resize-none"
                  />
                </div>
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full py-6 bg-white text-black font-black rounded-2xl hover:bg-gray-200 transition-colors duration-300 flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-xs shadow-[0_0_40px_rgba(255,255,255,0.1)]"
                >
