    ...
    <section id="contact" className="py-32 px-6 bg-black relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          >
            <div className="glass rounded-[3rem] p-8 md:p-12 border border-white/5 h-full">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6 group">
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold">aryansingh979211@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6 group">
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold">Gorakhpur, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-16 pt-10 border-t border-white/5 flex gap-4">
                ...
                <a href="https://www.instagram.com/iam_aryannnn07" target="_blank" rel="noreferrer" className="w-14 h-14 glass rounded-2xl flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all group">
          ...
          >
            <div className="glass rounded-[3rem] p-8 md:p-12 border border-white/5">
